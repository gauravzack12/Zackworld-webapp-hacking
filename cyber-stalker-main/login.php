...
elseif(isset($_SESSION['IAm-logined'])){
	...
	<body>
                               <div class="hackesking">
                              <img src="zackworld.png" alt="logo" height=100px width=100px />
                              <h1 style="color:white;">Cyber Stalker</h1>
                              </div>
	  ...
	  <div class="wrapper">
		...
		<bold> Disclaimer: We are not responsbile in case of cyber crime, use on own risk </bold>
		<h6> A tool created by <link href="" >Gauravzack</link></h6>
		</div>
	  </div>
